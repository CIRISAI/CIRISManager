...
class TestJailbreakerConfig:
    ...
    def test_config_creation(self):
        ...
        config = JailbreakerConfig(
            discord_client_id="test_client", discord_client_secret="test_secret"
        )
...
class TestJailbreakerRoutes:
    ...
    def mock_service(self):
        ...
        service.get_rate_limit_status = Mock(
            return_value={
    ...
    def test_oauth_callback_success(self, client, mock_service):
        ...
        response = client.post(
            "/jailbreaker/oauth/callback", json={"code": "oauth_code", "state": "state123"}
        )
