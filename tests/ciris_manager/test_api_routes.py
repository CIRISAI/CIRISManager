...
class TestAPIRoutes:
    ...
    def mock_manager(self):
        ...
        manager.template_verifier.list_pre_approved_templates = Mock(
            return_value={"scout": "Scout template", "sage": "Sage template"}
        )
        ...
        manager.get_status = Mock(
            return_value={
                "running": True,
                "components": {"watchdog": "running", "container_manager": "running"},
            }
        )
    ...
    def client(self, mock_manager, mock_auth):
        ...
        # Import the actual auth dependency used by routes
    ...
    def test_create_agent_success(self, client, mock_manager):
        ...
        response = client.post(
            "/manager/v1/agents",
            json={"template": "scout", "name": "Scout", "environment": {"CUSTOM": "value"}},
        )
    ...
    def test_create_agent_with_wa_signature(self, client, mock_manager):
        ...
        response = client.post(
            "/manager/v1/agents",
            json={"template": "custom", "name": "Custom", "wa_signature": "test_signature"},
        )
    ...
    def test_create_agent_invalid_template(self, client, mock_manager):
        ...
        response = client.post(
            "/manager/v1/agents", json={"template": "nonexistent", "name": "Test"}
        )
    ...
    def test_create_agent_permission_denied(self, client, mock_manager):
        ...
        response = client.post("/manager/v1/agents", json={"template": "custom", "name": "Custom"})
    ...
    def test_create_agent_internal_error(self, client, mock_manager):
        ...
        response = client.post("/manager/v1/agents", json={"template": "scout", "name": "Scout"})
    ...
    def test_list_templates(self, mock_glob, mock_exists, client, mock_manager):
        ...
        # Mock template files
        mock_template_files = [Mock(stem="scout"), Mock(stem="sage")]
